 ...
 */
public class ChargeHistoryListAdapter extends BaseAdapter{
    class ViewHolder {
    ...
    public ChargeHistoryListAdapter(Context context, List<ChargeHistory> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null) {
            ...
            view = vi.inflate(R.layout.charge_history_list_item, null);
        ...
        ChargeHistory chargeHistory = items.get(i);
